 ...
 */
final class Version20191127145906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE voltaire_resultats DROP score_evaluation');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE voltaire_resultats ADD score_evaluation INT NOT NULL');
    }
}
